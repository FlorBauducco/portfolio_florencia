  ...
  <SectionWrapper id="about">
    <div className="animate-fade-in-up">
      ...
      <div className="space-y-6 text-muted-foreground leading-relaxed text-lg">
        <p>
          Soy Florencia, <span className="font-bold">Desarrolladora de software junior</span> finalizando el Grado Superior en 
          Desarrollo de Aplicaciones Multiplataforma (DAM), con bases en 
